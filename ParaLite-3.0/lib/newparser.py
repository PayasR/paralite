...
join_op = COMMA | (Optional(NATURAL) + (Optional(INNER | CROSS | LEFT + OUTER | LEFT | OUTER) + JOIN).setParseAction(get_string_by_space))
...
if __name__=="__main__":
    ...
    sql = "create table x(a int, b real)"
